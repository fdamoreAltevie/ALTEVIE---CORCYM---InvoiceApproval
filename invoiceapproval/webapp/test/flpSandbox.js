		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#InvoiceApproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InvoiceApproval-display": {
								"semanticObject": "InvoiceApproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoiceapproval",
									"url": sap.ui.require.toUrl("invoiceapproval")
								}
							}
						}
					}
